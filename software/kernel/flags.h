...
/* BPI */
#define BPI_CTRL_START  (1 << CSR_FLASH_BPI_CONTROL_START_OFFSET)
#define BPI_CTRL_RW     (1 << CSR_FLASH_BPI_CONTROL_RW_OFFSET)
#define BPI_STATUS_DONE (1 << CSR_FLASH_BPI_STATUS_DONE_OFFSET)
